...
const SceneA = () => (
  ...
  >
    ...
    <div style={{ fontSize: 18, color: "#888", letterSpacing: 2 }}>
      THE BEGINNING
    </div>
  </AbsoluteFill>
);
...
const SceneB = () => (
  ...
  >
    ...
    <div
      style={{ fontSize: 18, color: "rgba(255,255,255,0.7)", letterSpacing: 2 }}
    >
      THE TRANSITION
    </div>
  </AbsoluteFill>
...
const GalleryItem = ({
  ...
  const MiniSceneB = () => (
    ...
    >
      ...
      <span style={{ color: "#fff", fontSize: 9, fontWeight: 500 }}>
        {label}
      </span>
    </AbsoluteFill>
  );
...
const TestimonialScene = () => (
  ...
  >
    ...
    >
      ...
      >
        This product completely transformed how our team collaborates. We've
  ...
  <AbsoluteFill style={{ background: "#0a0a0f" }}>
    ...
    >
      ...
      <div style={{ maxWidth: 350 }}>
        ...
        >
          Built on the latest technology stack for blazing fast performance and
            ...
            {["Dashboard", "Projects", "Tasks", "Team"].map((item, i) => (
              <div
                ...
                style={{
                  ...
                  borderRadius: 6,
                  background:
                    i === 0 ? "rgba(59, 130, 246, 0.2)" : "transparent",
                  color: i === 0 ? "#3b82f6" : "rgba(255,255,255,0.5)",
                  fontSize: 12,
                  marginBottom: 4,
                }}
              >
